...
%}
dirf = '/home/arshat/data/commets_all/small _data/new_t300/U-118_TAXOL_ARSHAT';
...
makechoose(tmax,carea,[]);%This script choose comets base on its form.

tr = 0.1:0.05:0.4;% treshold
dr =6:18; %blurring (or width of Aire circle) 
kr =3:0.2:30;%tail length of comet
cr = 40:0.2:50;%shift between max of intensity and tip of tube.
